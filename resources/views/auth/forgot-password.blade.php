    ...
    <div class="row justify-content-center">
        <div class="col-lg-4">
            <main class="form-reset">
                ...
                <form class="mb-2" action="{{ url('/forgot-password') }}" method="POST">
                    @csrf
                    <div class="form-floating">
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror rounded" id="email" placeholder="Email" value="{{ old('email') }}" required>
