        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="card card-primary card-outline">
                    <!-- form start -->
                    <form action="{{ url('/dashboard/prestasi/produk-inovatif') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" id="judul" value="{{ old('judul') }}" placeholder="Masukkan Judul Produk Inovatif" required>
                                @error('judul')
