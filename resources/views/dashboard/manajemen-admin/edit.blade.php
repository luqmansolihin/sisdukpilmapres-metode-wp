    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card card-primary card-outline">
                <!-- form start -->
                <form action="{{ url('/dashboard/manajemen-admin/'.$admin->nip) }}" method="POST" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Masukkan Nama Lengkap" value="{{ old('name', $admin->name) }}" required>
                            @error('name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nip" class="form-control @error('nip') is-invalid @enderror" id="nip" placeholder="Masukkan Nomor Identitas Pegawai" value="{{ old('nip', $admin->nip) }}" required>
                            @error('nip')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Masukkan Email" value="{{ old('email', $admin->user->email) }}" required>
                            @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="role" name="role" class="form-control @error('role') is-invalid @enderror" required>
                                ...
                                <option value="admin" @if (old('role', $admin->user->role) == 'admin') selected @endif>Admin</option>
                                <option value="dosen" @if (old('role', $admin->user->role) == 'dosen') selected @endif>Dosen</option>
                                <option value="juri" @if (old('role', $admin->user->role) == 'juri') selected @endif>Juri</option>
                            </select>
                            @error('role')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <select id="status" name="status" class="form-control @error('status') is-invalid @enderror" required>
                                ...
                                <option value="aktif" @if (old('status', $admin->user->status) == 'aktif') selected @endif>Aktif</option>
                                <option value="non-aktif" @if (old('status', $admin->user->status) == 'non-aktif') selected @endif>Non-Aktif</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">
                                    {{ $message }}
